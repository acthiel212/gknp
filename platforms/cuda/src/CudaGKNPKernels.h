...
public:
    CudaCalcGKNPForceKernel(std::string name, const OpenMM::Platform& platform, OpenMM::CudaContext& cu, const OpenMM::System& system) :
...
private:
    ...
    CudaOverlapTree *gtreems; //tree of MS particles overlaps
    ...
    double executeGKNP1(ContextImpl& context, bool includeForces, bool includeEnergy);
    double executeGKNP2(ContextImpl& context, bool includeForces, bool includeEnergy);
